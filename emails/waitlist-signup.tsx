...
<html dir="ltr" lang="en">
  ...
  <body
    ...
    <table
      ...
      cellspacing="0"
      role="presentation"
      style="max-width:500px;margin-left:auto;margin-right:auto;padding:32px">
      <tbody>
        <tr style="width:100%">
          <td>
            <table
              ...
              <tbody>
                <tr>
                  <td>
                    <h1
                      style="font-size:24px;font-weight:700;color:rgb(17,24,39);margin-bottom:20px">
                      You&#x27;re on the list!
                    </h1>
                    <p
                      style="font-size:16px;color:rgb(55,65,81);margin-bottom:20px;line-height:24px;margin-top:16px">
